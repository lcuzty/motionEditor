...
class URDFManipulator extends URDFViewer {
    ...
    constructor(...args) {
        ...
        dragControls.updateJoint = (joint, angle) => {
            ...
            const prev = this.jointValues && this.jointValues[joint.name];
            this.setJointValue(joint.name, angle);
            const next = this.jointValues && this.jointValues[joint.name];
            if (prev !== next) {
                this.dispatchEvent(new CustomEvent('angle-change', { bubbles: true, cancelable: true, detail: joint.name }));
            }
